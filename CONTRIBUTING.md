...
```
   git clone https://github.com/YOUR_USERNAME/Automated-Insta-Reel-Collector-And-Poster.git
```
...
```
   git remote add upstream https://github.com/eccentriccoder01/Automated-Insta-Reel-Collector-And-Poster.git
```
